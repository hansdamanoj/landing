!(function (i) {
    ...
    isNaN(o) || 0 >= o
        ? ((i.fn.carousel.Constructor.TRANSITION_DURATION = 1e3), i(".carousel-inner > .item").css({ "-webkit-transition-duration": o + "1000ms", "-moz-transition-duration": o + "1000ms", "transition-duration": o + "1000ms" }))
        : ((i.fn.carousel.Constructor.TRANSITION_DURATION = o), i(".carousel-inner > .item").css({ "-webkit-transition-duration": o + "ms", "-moz-transition-duration": o + "ms", "transition-duration": o + "ms" }));
    ...
    h &&
        i(".thumb_scroll_y").on("slid.bs.carousel", function () {
            ...
            0 > o && (o = 0), o > s - i(".thumb_scroll_y .carousel-indicators").height() && (o = s - i(".thumb_scroll_y .carousel-indicators").height()), i(".thumb_scroll_y .carousel-indicators").animate({ scrollTop: o }, 800), (c = o);
        }),
        d &&
            i(".thumb_scroll_x").on("slid.bs.carousel", function () {
                ...
                0 > o && (o = 0), o > s - i(".thumb_scroll_x .carousel-indicators").width() && (o = s - i(".thumb_scroll_x .carousel-indicators").width()), i(".thumb_scroll_x .carousel-indicators").animate({ scrollLeft: o }, 800), (u = o);
            }),
